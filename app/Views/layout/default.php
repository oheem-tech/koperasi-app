...
<?php if (session()->get('isLoggedIn')): ?>
    ...
    <div class="sidebar">
        <div class="sidebar-brand text-center">
            ...
            <?php endif; ?>
            <?php $updaterConfig = new \Config\Updater(); ?>
            <div style="margin-top: 10px; font-size: 0.7rem; color: #64748b; font-weight: 600; letter-spacing: 0.3px;">sherka v<?= $updaterConfig->currentVersion; ?></div>
        </div>
